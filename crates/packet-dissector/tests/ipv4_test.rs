...
//! |-------------|--------------------------------|---------------------------------|
//! | 3.1         | Version, IHL                   | parse_ipv4_basic                |
//! | 3.1         | IHL < 5 invalid                | parse_ipv4_invalid_ihl          |
//! | 3.1         | DSCP (RFC 2474), ECN (RFC 3168)| parse_ipv4_basic                |
//! | 3.1         | Total Length                   | parse_ipv4_basic                |
//! | 3.1         | Identification                 | parse_ipv4_basic                |
//! | 3.1         | Flags (DF)                     | parse_ipv4_basic                |
//! | 3.1         | Flags (MF) + Fragment Offset   | parse_ipv4_fragmented           |
//! | 3.1         | TTL                            | parse_ipv4_basic                |
//! | 3.1         | Protocol (TCP=6)               | parse_ipv4_basic                |
//! | 3.1         | Protocol (UDP=17)              | parse_ipv4_udp_protocol         |
//! | 3.1         | Header Checksum                | parse_ipv4_basic                |
//! | 3.1         | Source / Destination Address    | parse_ipv4_basic                |
//! | 3.1         | Options (IHL > 5)              | parse_ipv4_with_options          |
//! | —           | Truncated header               | parse_ipv4_truncated            |
//! | —           | Truncated with options          | parse_ipv4_truncated_with_options|
//! | 3.1         | Version must be 4              | parse_ipv4_invalid_version      |
//! | 3.1         | Total Length < IHL*4 invalid    | parse_ipv4_total_length_too_small |
//! | 3.1         | Total Length > data truncated   | parse_ipv4_total_length_exceeds_data |
